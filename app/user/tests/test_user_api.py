...
CREATE_USER_URL = reverse('user:create')  # endpoint /api/user/create
TOKEN_URL = reverse('user:token')         # endpoint /api/user/token
ME_URL = reverse('user:me')               # endpoint /api/user/me
